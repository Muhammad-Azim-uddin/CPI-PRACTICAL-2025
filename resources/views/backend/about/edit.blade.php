        ...
        <form action="{{ route('backend.about.update', $about->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6"><h5>Edit about Post</h5></div>
                        <div class="col-lg-6 text-end">
                            <button name="status" value="draft" class="btn btn-warning me-2">Save As Draft</button>
                            <button name="status" value="publish" class="btn btn-primary">Update & Publish</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-9">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea name="short_description" id="short_description">{{ old('short_description', $about->short_description) }}</textarea>
                            @error('short_description') <small class="text-danger d-block">{{ $message }}</small> @enderror
                        </div>
                        <div class="form-group mb-2">
                            <label>Long Description <span class="text-danger">*</span></label>
                            <textarea name="long_description" id="details">{{ old('long_description', $about->long_description) }}</textarea>
                        ...
                        <div class="form-group mb-2">
                            ...
                            @if ($about->image)
                                <img src="{{ asset('storage/' . $about->image) }}" width="100" class="mb-2"><br>
                            @endif
                ...
                <div class="col-lg-3 mt-3">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title', $about->meta_title) }}">
